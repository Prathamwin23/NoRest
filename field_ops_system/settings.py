...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'field_ops'),
...
OPENROUTESERVICE_API_KEY = os.environ.get('OPENROUTESERVICE_API_KEY', 'your_api_key_here')

FCM_DJANGO_SETTINGS = {
    "FCM_SERVER_KEY": os.environ.get('FCM_SERVER_KEY', 'your_firebase_key_here'),
